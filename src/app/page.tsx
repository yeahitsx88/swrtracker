...
export default function Home() {
  return <Shell><p className="eyebrow">Field operations</p>
    ...
    <p className="muted">Open your projects to start a survey request, or pick up a draft you have already saved.</p>
    <div className="actions"><Link className="button" href="/projects">Open my projects</Link><Link className="button secondary" href="/drafts">Open my drafts</Link>
